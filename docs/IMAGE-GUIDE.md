# Image Guide — Vendor Sources & Workflow

Рабочий процесс: вы выбираете фото на официальной vendor-странице → шлёте мне URL или скриншот → я обновляю `js/images.js` в одной строке. Картинка меняется на всех 12 страницах, где используется соответствующий ключ.
