...
- The working model is **asymmetric 80 / 20**: Artsiom Ishchuk is Managing Partner and initiates everything; Anatoliy Shiva contributes ~5–6 hours a week, Accent Florida Home contacts and client introductions, the low-voltage licence route, and a start-up finance envelope (marketing, licences, certifications, Google / Meta, Angi, Thumbtack, CPA, first buys). LUMA is **not** Anatoliy's main focus — he continues to develop Accent Florida Home. Equity percentages stay as blanks — they need not match the work split. Cash waterfall (§9): direct project costs, then Artsiom's living draw (first fruits), then commission, opex, reserve, profit. Anatoliy may cover Artsiom's personal bills 1–2 times, max $7,000, as a repayable advance; if unpaid in cash, Artsiom works the balance off at Accent Florida Home. Модель работы **асимметричная 80 / 20**: Artsiom Ishchuk — Управляющий партнёр и вся инициация; Anatoliy Shiva — ~5–6 часов в неделю, контакты Accent Florida Home, путь к лицензии low voltage и конверт денег на старт. LUMA — **не** его основной фокус: основной бизнес — Accent Florida Home. Проценты долей в таблице остаются пропусками. Каскад §9: прямые расходы проекта → изъятие Artsiom на жизнь → комиссия → операционка → резерв → прибыль. Anatoliy может закрыть личные счета Artsiom 1–2 раза, всего не более $7,000, как возвратный аванс; если деньгами вернуть нельзя — отработка в Accent Florida Home.
- It assumes **limited cash at the start**: Seed Cap plus Partner B's launch envelope (§7), client deposits funding project hardware, loss exposure capped at the Seed Cap (§8). Он исходит из ограниченных денег на старте: Стартовый лимит плюс конверт Партнёра Б, оборудование за счёт авансов клиентов, потолок по убыткам.
