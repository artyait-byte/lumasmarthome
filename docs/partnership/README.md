...
- The working model is **asymmetric 80 / 20**: Artsiom Ishchuk is Managing Partner and initiates everything; Anatoliy Shiva contributes ~5–6 hours a week, Accent Florida Home contacts and client introductions, the low-voltage licence route, and a start-up finance envelope (marketing, licences, certifications, Google / Meta, Angi, Thumbtack, CPA, first buys). Equity percentages stay as blanks — they need not match the work split. Модель работы **асимметричная 80 / 20**: Artsiom Ishchuk — Управляющий партнёр и вся инициация; Анатолий Шива — ~5–6 часов в неделю, контакты Accent Florida Home, путь к лицензии low voltage и конверт денег на старт (маркетинг, лицензии, сертификации, Google / Meta, Angi, Thumbtack, CPA, первые закупки). Проценты долей в таблице остаются пропусками — они не обязаны совпадать с рабочим разделом.
