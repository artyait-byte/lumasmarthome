...
- It assumes **limited cash**: monthly spend is **only regular costs** (leads, marketing, AI tokens, GHL, subscriptions) — **September $500**; Angi, Thumbtack and other lead platforms **not more than $1,500 per month**; anything else only after Artsiom's written request (purpose + amount). B Facility cap **$10,000** at 6% simple. Hardware from client deposits. Месячная минималка сентябрь $500; площадки не более $1,500/мес; остальное — по запросу А.
