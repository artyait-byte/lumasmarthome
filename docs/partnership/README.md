...
- The working model is **asymmetric 80 / 20**: Artsiom Ishchuk is Managing Partner — **at least 25 hours per week in the first 4 weeks**, then a written review of whether that focus is producing results; Anatoliy Shiva contributes **6 hours a week**, Accent Florida Home contacts and client introductions, and the low-voltage licence route. LUMA is **not** Anatoliy's main focus — he continues to develop Accent Florida Home. A **weekly KPI list** is written in the first 14 days: each week the Partners either hit it or write the gap and the next action. Equity percentages stay as blanks. Cash waterfall (§9): direct project costs, then Artsiom's living draw (first fruits), then commission, opex, reserve, profit. Anatoliy may cover Artsiom's personal bills 1–2 times, max $7,000, as a repayable advance; if unpaid in cash, Artsiom works the balance off at Accent Florida Home. Модель **асимметричная 80 / 20**: Artsiom — не менее 25 часов в неделю в первые 4 недели, затем разбор фокуса; Anatoliy — 6 часов в неделю. Еженедельный перечень KPI: закрыть или записать разрыв и следующий шаг.
- It assumes **limited cash and no debt above the B Facility**: Partner A puts in time, not cash. Partner B's **B Facility is capped at $10,000 outstanding** (§7) — start-up investment repaid from each new project's remaining margin (**10% of outstanding principal + 6% simple per annum**), or a credit line the Project may draw for bills, invoices and services at the same 6%. Narrow start list: AI tools, website, aggregator lead-gen (Angi, Thumbtack, Houzz, Yelp), test Meta ads only after packages are ready, photo/video at the start, courses/certificates (e.g. SBDC, public-tender access). Hardware from client deposits. If the funnel is not converting, paid marketing is not scaled and the budget is not burned (§8). Он исходит из ограниченных денег: лимит Б не более $10,000 остатка, возврат 10% остатка + 6% годовых с маржи каждого проекта, либо кредитная линия на ту же сумму; сверх этого долги не копим.
